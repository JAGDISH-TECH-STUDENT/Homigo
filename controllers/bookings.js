...
module.exports.createBooking = async (req, res, next) => {
    try {
        ...
        // Prevent hosts from booking listings - only guests can book
        ...
        // Check for overlapping bookings (availability)
        ...
        // Calculate total price with service fee (12%)
        const subtotal = listing.price * nights;
        const serviceFee = Math.round(subtotal * 0.12);
        const totalPrice = subtotal + serviceFee;

        // Check guest capacity if listing has maxGuests defined
...
module.exports.getBookingDetails = async (req, res, next) => {
    try {
        ...
        // Only allow the booking user to view details
...
// Get all bookings for listing owner
module.exports.getListingBookings = async (req, res, next) => {
    try {
        ...
        // Only listing owner can view bookings
        if (!listing.owner.equals(req.user._id)) {
...
// Get host dashboard with all bookings
